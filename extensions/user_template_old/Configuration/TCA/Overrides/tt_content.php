...
call_user_func(function () {
    ...
    $customLanguageFilePrefix = 'LLL:EXT:user_template/Resources/Private/Language/locallang_be.xlf:';
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
        ...
        'CType',
        [
            'LLL:EXT:user_template/Resources/Private/Language/locallang_be.xlf:wizard.title',
            'fs_slider',
            'content-image'
        ],
        'textmedia',
    ...
    $GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['fs_slider'] = $GLOBALS['TCA']['tt_content']['ctrl']
    ['typeicon_classes']['textmedia'];
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
        '',
        'FILE:EXT:user_template/Configuration/FlexForms/fs_slider_flexform.xml',
        'fs_slider'
    );
});
